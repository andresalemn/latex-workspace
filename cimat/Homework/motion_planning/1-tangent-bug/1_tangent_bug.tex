...
\newcommand{\enterProblemHeader}[2]{
	\nobreak\extramarks{}{Problem \arabic{#1}: #2\ continued on next page\ldots}\nobreak{}
	\nobreak\extramarks{Problem \arabic{#1}: #2\ (continued)}{Problem \arabic{#1}: #2\ continued on next page\ldots}\nobreak{}
}
